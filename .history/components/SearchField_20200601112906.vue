...
input{
    ...
    &:active{
      width: 100%;
      -webkit-transition: transform 1s ease-in-out, width 1s ease-in-out 1s;
      -moz-transition: transform 1s ease-in-out, width 1s ease-in-out 1s;
      -o-transition: transform 1s ease-in-out, width 1s ease-in-out 1s;
      transition: transform 1s ease-in-out, width 1s ease-in-out 1s;

  ...
  <div aria-hidden="true">
    <svg class="album" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg" role="img">
      <defs>
        ...
        >
          <image x="0%" y="0%" width="100%" height="100%" v-bind="{'xlink:href': image }" />
        </pattern>
      </defs>
      <rect height="25" width="25" class="image" x="0" y="0" />
    </svg>
    <svg class="progress" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stop-color="#333642" />
          <stop offset="25%" stop-color="rgba(0, 112, 255, 0.8)" />
          <stop offset="90%" stop-color="rgba(118, 120, 224, 0.5)" />

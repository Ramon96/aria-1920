...
input{
    ...
    &:active{
      width: 100%;
      -webkit-transition: width 1s ease-in-out, transform 1s ease-in-out;
      -moz-transition: width 1s ease-in-out, transform 1s ease-in-out;
      -o-transition: width 1s ease-in-out, transform 1s ease-in-out;

...
input{
    ...
    &:active{
      width: 100%;
      -webkit-transition: transform 1s ease-in-out 1s, width 1s ease-in-out;
      -moz-transition: transform 1s ease-in-out 1s, width 1s ease-in-out;
      -o-transition: transform 1s ease-in-out 1s, width 1s ease-in-out;
      transition: transform 1s ease-in-out 1s, width 1s ease-in-out;
